...
# with open("informations.csv", encoding="utf8") as page1:
#     data1 = csv.reader(page1)

informations = pandas.read_csv("informations.csv")
informations_dict = informations.to_dict()
# print(informations_dict)

title_list = informations["Title"].to_list()
# print(title_list)

input_list = informations["Input"].to_list()
# print(input_list)
